...
#     _ = sns.rugplot(
#         data, height=-0.02, clip_on=False, hue=binary_labels, palette=comp_colors
#     )
...
#     _ = sns.histplot(
#         score1, color="#B0B0B0", ax=ax1, alpha=0.25, kde=False, stat="density"
#     )
#     _ = sns.kdeplot(score1, linewidth=2, color=comp_colors_density, ax=ax1)
#     _ = sns.rugplot(
#         score1, height=-0.02, clip_on=False, hue=score_1, palette=comp_colors, ax=ax1
#     )
...
# def visualize_for_cat(gs_name, score1, score2, thr1, thr2, name1, name2, save_dir):
#     if thr2 is not None:
#         compare_2_categorical(
#             score1,
#             thr1,
#             name1,
#             gs_name,
